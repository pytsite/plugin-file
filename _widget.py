...
from pytsite import tpl as _tpl, html as _html, router as _router, http_api as _http_api
...
class FilesUpload(_widget.Abstract):
    ...
    def _get_element(self, **kwargs) -> _html.Element:
        ...
        return _html.TagLessElement(_tpl.render('file@file_upload_widget', {'widget': self}))
